    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 pt-20 pb-24 md:pt-28 md:pb-32">
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="max-w-lg animate-fade-in">
              <p className="type-eyebrow mb-5">Wholesale · 100 Pack</p>
              ...
              <div className="mt-10">
                <Link
                  to="/order-now"
                  className="type-cta inline-flex items-center gap-2 h-12 px-8 bg-primary text-primary-foreground rounded-sm transition-colors hover:bg-foreground/90"
                >
                  Order Now
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-20 md:py-28">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div className="order-1 md:order-2">
              <p className="type-eyebrow mb-3">What&apos;s Inside</p>
              <h2 className="type-display-sm">
                Premium clear cans,
                <br />
                ready to ship.
              </h2>
              <ul className="mt-8 space-y-4 type-body-sm">
              ...
              <Link
                to="/order-now"
                className="type-cta inline-flex items-center gap-2 mt-8 text-foreground hover:text-muted-foreground transition-colors"
              >
                View pricing & order
                <ArrowRight className="w-4 h-4" />
              </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 md:gap-16">
            {[
              ...
              <div key={feature.title}>
                <h3 className="type-label">{feature.title}</h3>
      ...
      <section className="border-t border-border">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-20 md:py-28 text-center">
          <h2 className="type-display-sm">Ready to stock up?</h2>
          <p className="type-body mt-3 max-w-md mx-auto">
            Get the clear cans everyone trusts. Starting at {priceDisplay} per box of 100.
          </p>
          <Link
            to="/order-now"
            className="type-cta inline-flex items-center gap-2 h-12 px-10 mt-8 bg-primary text-primary-foreground rounded-sm transition-colors hover:bg-foreground/90"
          >
            Place Your Order
            <ArrowRight className="w-4 h-4" />
          </Link>
